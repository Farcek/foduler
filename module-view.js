...
module.exports = new (require('./index').Moduler)("$moduleViewEngine", '$view')
    ...
    .factory('engine', function (swig, Loader) {
...
function dd(foduler) {
    return foduler.module('view-engine').as('$view')
        ...
        .factory('engine', ['swig', 'multiLoader',
